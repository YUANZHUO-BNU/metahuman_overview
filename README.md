...
![未命名文件](https://github.com/user-attachments/assets/2b60395f-dcfb-4703-bdbb-bd98586a5e80)
...
这种方法的优点是生成的数字人在保证真实的情况下，又带一些卡通，可以显著降低恐怖谷效应（所有观看者的反馈）。
![demo2](https://github.com/user-attachments/assets/d05a75a0-41cc-4de6-b57c-a63022367260)
...
#### 4. 后期合成
数字人进行抠像后与PPT逐页合成，
优化：如果抠像发现部分不完善，请通过PS等软件将png照片素材部分填充白色背景尝试解决。
